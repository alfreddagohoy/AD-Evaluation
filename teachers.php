...
$page->title = "Teachers List | ". $set->site_name;

$presets->setActive("teacherslist"); // we highlight the home link
...
echo "
<div class='container'>
<h3 class='pull-left'>Students List <a class='btn btn-success' href='$set->url'>Manage</a></h3>
