...
class Options
{
	...
	*/
	public function isValidMail($mail) {
		...
		if(!checkdnsrr("localhost", "MX")) // if we have no internet access on the server
		return TRUE;
	...
	public function sendMail($to, $subject, $message, $from = 'From: noreply@localhost', $isHtml = true) {
